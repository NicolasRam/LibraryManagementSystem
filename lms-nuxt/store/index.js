    ...
    return new Vuex.Store({
        ...
        actions: {
            ...
            addBestSellingBook(vuexContext, bestSellingBook) {
                ...
                return this.$axios
                    .$post(
                        "http://54.36.182.3/lms/public/index.php/api/bestSellingBooks?auth=" +
                        vuexContext.state.token,
            ...
            editBestSellingBook(vuexContext, editedBestSellingBook) {
                return this.$axios
                    .$put(
                        "http://54.36.182.3/lms/public/index.php/api/bestSellingBooks/" +
            ...
            addFeaturedBook(vuexContext, featuredBook) {
                ...
                return this.$axios
                    .$post(
                        "http://54.36.182.3/lms/public/index.php/api/featuredBook?auth=" +
                        vuexContext.state.token,
                        createdFeaturedBook
                    )
                    .then(data => {
            ...
            editFeaturedBook(vuexContext, editedFeaturedBook) {
                return this.$axios
                    .$put(
                        "http://54.36.182.3/lms/public/index.php/api/featuredBook/" +
            ...
            addNewReleaseBook(vuexContext, newReleaseBook) {
                ...
                return this.$axios
                    .$post(
                        "http://54.36.182.3/lms/public/index.php/api/newReleaseBooks?auth=" +
                        vuexContext.state.token,
            ...
            editNewReleaseBook(vuexContext, editedNewReleaseBook) {
                return this.$axios
                    .$put(
                        "http://54.36.182.3/lms/public/index.php/api/newReleaseBooks/" +
            ...
            addCollectionCount(vuexContext, collectionCount) {
                ...
                return this.$axios
                    .$post(
                        "http://54.36.182.3/lms/public/index.php/api/collectionCounts?auth=" +
                        vuexContext.state.token,
            ...
            editCollectionCount(vuexContext, editedCollectionCount) {
                return this.$axios
                    .$put(
                        "http://54.36.182.3/lms/public/index.php/api/collectionCounts/" +
            ...
            addPickedByAuthorBook(vuexContext, pickedByAuthorBook) {
                ...
                return this.$axios
                    .$post(
                        "http://54.36.182.3/lms/public/index.php/api/pickedByAuthorBooks?auth=" +
                        vuexContext.state.token,
            ...
            editPickedByAuthorBook(vuexContext, editedPickedByAuthorBook) {
                return this.$axios
                    .$put(
                        "http://54.36.182.3/lms/public/index.php/api/pickedByAuthorBooks/" +
            ...
            addTestimonial(vuexContext, testimonial) {
                ...
                return this.$axios
                    .$post(
                        "http://54.36.182.3/lms/public/index.php/api/testimonials?auth=" +
                        vuexContext.state.token,
                        createdTestimonial
                    )
                    .then(data => {
            ...
            editTestimonial(vuexContext, editedTestimonial) {
                return this.$axios
                    .$put(
                        "http://54.36.182.3/lms/public/index.php/api/testimonials/" +
            ...
            addMostPopularAuthor(vuexContext, mostPopularAuthor) {
                ...
                return this.$axios
                    .$post(
                        "http://54.36.182.3/lms/public/index.php/api/mostPopularAuthors?auth=" +
                        vuexContext.state.token,
            ...
            editMostPopularAuthor(vuexContext, editedMostPopularAuthor) {
                return this.$axios
                    .$put(
                        "http://54.36.182.3/lms/public/index.php/api/mostPopularAuthors/" +
            ...
            addCallToAction(vuexContext, callToAction) {
                ...
                return this.$axios
                    .$post(
                        "http://54.36.182.3/lms/public/index.php/api/callToAction?auth=" +
                        vuexContext.state.token,
                        createdCallToAction
                    )
                    .then(data => {
            ...
            editCallToAction(vuexContext, editedCallToAction) {
                return this.$axios
                    .$put(
                        "http://54.36.182.3/lms/public/index.php/api/callToAction/" +
            ...
            addLatestPost(vuexContext, latestPost) {
                ...
                return this.$axios
                    .$post(
                        "http://54.36.182.3/lms/public/index.php/api/latestPosts?auth=" +
                        vuexContext.state.token,
                        createdLatestPost
                    )
                    .then(data => {
            ...
            editLatestPost(vuexContext, editedLatestPost) {
                return this.$axios
                    .$put(
                        "http://54.36.182.3/lms/public/index.php/api/latestPosts/" +
                        editedLatestPost.id +
                        ".json?auth=" +
                        vuexContext.state.token,
                        editedLatestPost
            ...
            addBestSellingAuthor(vuexContext, bestSellingAuthor) {
                ...
                return this.$axios
                    .$post(
                        "http://54.36.182.3/lms/public/index.php/api/bestSellingAuthors?auth=" +
                        vuexContext.state.token,
            ...
            editBestSellingAuthor(vuexContext, editedBestSellingAuthor) {
                return this.$axios
                    .$put(
                        "http://54.36.182.3/lms/public/index.php/api/bestSellingAuthors/" +
        ...
        getters: {
            ...
            loadedFeaturedBooks(state) {
                return state.loadedFeaturedBooks;
            },
