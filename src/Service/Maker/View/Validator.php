...
use App\Service\Maker\View\Exception\RuntimeCommandException;
...
{
    public static function validateClassName(string $className = 'App\\Entity\\Book', string $errorMessage = ''): string
    {
