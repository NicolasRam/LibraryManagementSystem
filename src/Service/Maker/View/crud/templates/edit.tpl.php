...
{% block page_title 'page.title.<?= $route_name ?>.edit' | trans({}, 'page') %}

{% trans_default_domain 'form' %}

{% block page_content_portlet_head_title 'page.title.<?= $route_name ?>.edit' | trans({}, 'page')  %}
